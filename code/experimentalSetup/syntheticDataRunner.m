function wsRun = syntheticDataRunner(threshold, starti, endi, tagSrc, tagAlg, varargin)
...
% save option
folder = "cmum/asg/runT" + num2str(starti);
...
for iBin = 1 : 1
    ...
    wsBin = syntheticDataExp(threshold, starti, tagSrc, tagAlg, iBin, 'svL', 2);
