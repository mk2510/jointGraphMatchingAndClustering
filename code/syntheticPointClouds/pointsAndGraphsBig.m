function [P,Q, KP, KQ, X_gt, gphs, permConstraint, node_aff, W1, W2,A,B] = pointsAndGraphsBig(id1, id2, id3, id4)

[P,Q] = newSceneBig(id1, id2, id3, id4);
