function [P,Q, KP, KQ, X_gt, gphs, permConstraint, node_aff, W1, W2,A,B] = pointsAndGraphsSmall(id1)

[P,Q] = newSceneSmall(id1);
...
Eg1 = [1 2;
    ...
    3 4;
    1 5; 2 5;3 5;4 5;
    6 7;6 8;7 9;8 9;10 6; 10 8; 11 9; 11 7;11 5;
    2 8; 5 6];
[p,q] = size(Eg1);
for i = 1:p
    for j = 1:q
        Eg2(i,j) = permutateNumber(Eg1(i,j), X);
    end
end
