function [X_proj,R_proj,X,R, objective, y1,y2,A1, A2] = solvePMSDP2_out(P,Q,W1, W2, params, num_of_emb, groupLs)
%===============================================================
% module:
% ------
% solvePMSDP.m
...
tic
[a,b] = size(groupLs{1});
[F,obj1,problem] = generateConstraints2_out(problem,params,1, a, groupLs{1});
obj = obj1;
for i = 2:num_of_emb
[a,b] = size(groupLs{i});
[Fi,obji,problem] = generateConstraints2_out(problem,params,i, a, groupLs{i});
F = [F Fi];
obj = obj + obji;
end
[obc Fc] = genClusterConstraints_out(problem);
F = [F Fc];
obj = obj - obc;
toc
%============================================
